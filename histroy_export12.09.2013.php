...
$objPHPExcel->getActiveSheet()->setCellValue('I1', "Over alle reacties");
$objPHPExcel->getActiveSheet()->getStyle('I1')->getFont()->setBold(true);

$objPHPExcel->getActiveSheet()->setCellValue('J1', "extra informatie");
...
for($v = 0; $v < $CntDataExcelArr; $v++) {
	...
	$objPHPExcel->getActiveSheet()->setCellValue('D'.$x, $DataExcelArr[$v]['TNAME_T_TASK_ID']);
